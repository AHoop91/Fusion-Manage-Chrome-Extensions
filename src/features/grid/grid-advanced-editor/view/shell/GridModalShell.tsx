...
export interface ModalDomRefs {
  ...
  importFileAction: HTMLButtonElement
  commitAction: HTMLButtonElement
  commitAndCloseAction: HTMLButtonElement
}
    ...
    <div ref={capture.panel} className="plm-extension-grid-form-panel">
      <div className="plm-extension-grid-form-header">
        <div>
          ...
          <div ref={capture.loading} className="plm-extension-grid-form-loading">
            <GenericLoader label="Loading metadata..." inline labelRef={capture.loadingText} />
          </div>
        </div>
      ...
      <div ref={capture.body} className="plm-extension-grid-form-body">
        <div ref={capture.left} className="plm-extension-grid-form-left">
          <div className="plm-extension-grid-form-left-header">
            ...
            <div ref={capture.leftActions} className="plm-extension-grid-form-left-actions">
              ...
              <button ref={capture.editAction} type="button" className="plm-extension-grid-form-action plm-extension-btn plm-extension-btn--secondary">Edit Selected</button>
        ...
        <div ref={capture.bodyLoading} className="plm-extension-grid-form-body-loading">
          <GenericLoader label="Loading Advanced Editor..." />
        </div>
      </div>
      ...
      <div className="plm-extension-grid-form-footer">
        ...
        <div className="plm-extension-grid-form-actions">
          ...
          <button ref={capture.commitAction} type="button" className="plm-extension-grid-form-action plm-extension-btn plm-extension-btn--secondary">Save</button>
          <button ref={capture.commitAndCloseAction} type="button" className="plm-extension-grid-form-action plm-extension-grid-form-action--primary plm-extension-btn plm-extension-btn--primary">Save &amp; Close</button>
        </div>
      </div>
    </div>
  )
...
export function buildModalDom(): ModalDomRefs {
  ...
  let importFileAction: HTMLButtonElement | null = null
  let commitAction: HTMLButtonElement | null = null
  let commitAndCloseAction: HTMLButtonElement | null = null
    ...
    root.render(
      <GridModalShell
        capture={{
          ...
          importFileAction: (node) => { importFileAction = node },
          commitAction: (node) => { commitAction = node },
          commitAndCloseAction: (node) => { commitAndCloseAction = node }
        }}
      />
    )
  })
