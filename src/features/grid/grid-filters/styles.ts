...
export function getGridPanelStyleText(): string {
  return [
    ...
    `#${GRID_FILTER_TOGGLE_BUTTON_ID} .icon-Filter{display:inline-block;font-size:18px;line-height:1;}`,
    `#${GRID_FILTER_TOGGLE_BUTTON_ID} .plm-extension-grid-filter-text{line-height:1;}`,
    `#${GRID_EXPORT_BUTTON_ID}{gap:6px;}`,
    `#${GRID_EXPORT_BUTTON_ID} .export-excel-btn{width:18px;height:18px;display:block;}`,
    `#${GRID_EXPORT_BUTTON_ID} .plm-extension-grid-export-text{line-height:1;}`,
    `#${GRID_IMPORT_BUTTON_ID}{gap:6px;}`,
    `#${GRID_IMPORT_BUTTON_ID} .plm-extension-grid-import-icon{display:inline-flex;align-items:center;justify-content:center;font-size:18px;line-height:1;}`,
    `#${GRID_IMPORT_BUTTON_ID} .plm-extension-grid-import-text{line-height:1;}`,
