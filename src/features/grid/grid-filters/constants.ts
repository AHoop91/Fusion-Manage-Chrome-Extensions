...
} from '../grid-page/grid-page.constants'
...
export const GRID_IMPORT_BUTTON_ID = 'plm-extension-grid-filter-import'
/** Fusion Manage host toolbar icons (same as native grid Excel CSV actions). */
export const GRID_EXPORT_EXCEL_ICON_SRC = 'images/export_excel_btn.svg'
