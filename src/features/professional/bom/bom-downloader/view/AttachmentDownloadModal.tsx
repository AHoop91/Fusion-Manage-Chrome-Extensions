...
function WarningGlyph(): React.JSX.Element {
  return (
    <svg
      className="plm-extension-bom-attachment-download-path-risk-icon"
      viewBox="0 0 24 24"
      width="44"
      height="44"
      aria-hidden="true"
...
export function AttachmentDownloadModal(props: AttachmentDownloadHandlers): React.JSX.Element {
  ...
  const pathLengthRiskDialog = showPathLengthRiskDialog ? (
    <div
      className="plm-extension-bom-attachment-download-path-risk-overlay"
      role="presentation"
      onClick={(event) => {
    ...
    >
      <div
        className="plm-extension-bom-attachment-download-path-risk-modal"
        role="alertdialog"
        aria-modal="true"
        aria-live="polite"
      ...
      >
        <div className="plm-extension-bom-attachment-download-path-risk-copy">
          ...
          <strong
            ...
            className="plm-extension-bom-attachment-download-path-risk-title"
          >
            Download Path Length Risk
          </strong>
          <span className="plm-extension-bom-attachment-download-path-risk-text">
        ...
        <div className="plm-extension-bom-attachment-download-path-risk-actions">
          <button
            type="button"
            className="plm-extension-bom-attachment-download-path-risk-btn plm-extension-bom-attachment-download-path-risk-btn--secondary"
          ...
          <button
            type="button"
            className="plm-extension-bom-attachment-download-path-risk-btn plm-extension-bom-attachment-download-path-risk-btn--primary"
            onClick={() => {
              setShowPathLengthRiskDialog(false)
              void startDownloadFiles()
            }}
          ...
          <div className="plm-extension-bom-attachment-download-preview-body">
            {bomLoading ? (
              <div className="plm-extension-bom-attachment-download-empty">
                <GenericLoader label="Loading Bill of Materials" className="plm-extension-bom-clone-loading-center" />
              </div>
            ) : bomError ? (
