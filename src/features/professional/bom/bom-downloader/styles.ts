import { buildBomScopeStyles } from '../bom-shared/styles'
...
.plm-extension-bom-attachment-download-path-risk-overlay{
  position:fixed;
  inset:0;
  z-index:2147483647;
  display:flex;
...
.plm-extension-bom-attachment-download-path-risk-modal{
...
.plm-extension-bom-attachment-download-path-risk-copy{
  display:flex;
  flex-direction:column;
  gap:10px;
  align-items:center;
...
.plm-extension-bom-attachment-download-path-risk-icon{
  display:block;
  width:44px;
  height:44px;
  margin:0 auto 6px;
}
.plm-extension-bom-attachment-download-path-risk-title{
  display:block;
  font-family:var(--plm-bom-font-sans);
  font-size:26px;
  line-height:1.12;
...
.plm-extension-bom-attachment-download-path-risk-text{
  max-width:520px;
  font:500 14px/1.6 var(--plm-bom-font-sans);
}
.plm-extension-bom-attachment-download-path-risk-actions{
  display:flex;
  justify-content:flex-end;
  gap:10px;
  margin-top:2px;
}
.plm-extension-bom-attachment-download-path-risk-btn{
  min-height:38px;
  padding:0 16px;
  border-radius:8px;
  font:600 12px/1 var(--plm-bom-font-sans);
...
.plm-extension-bom-attachment-download-path-risk-btn--secondary{
  border:1px solid #ccd7e2;
  background:#ffffff;
  color:#203246;
}
.plm-extension-bom-attachment-download-path-risk-btn--primary{
  border:1px solid #149cd8;
  background:#149cd8;
  color:#ffffff;
}
