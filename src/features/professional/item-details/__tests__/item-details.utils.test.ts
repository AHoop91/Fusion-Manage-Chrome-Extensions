...
describe('item-details utils', () => {
  ...
  it('extracts workspace id from item-details URLs', () => {
    expect(getWorkspaceIdFromUrl('https://test.autodeskplm360.net/plm/workspaces/57/items/itemDetails')).toBe(57)
    expect(getWorkspaceIdFromUrl('https://test.autodeskplm360.net/plm/nope')).toBeNull()
  })
