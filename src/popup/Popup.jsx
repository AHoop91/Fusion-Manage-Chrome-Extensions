...
import { RUNTIME_TOGGLE_ROWS, isFlagInBuild } from './runtimeToggleDefs';
...
function FeaturesPanel({ effective, shippedRows, onToggle, onReset, statusNote }) {
    ...
    return (
        <section className="features-section" aria-labelledby="features-panel-heading">
            ...
            {statusNote ? <p className="features-status" role="status">{statusNote}</p> : null}
            {shippedCount === 0 ? (
                    ...
                    {shippedRows.map((row) => {
                        ...
                        return (
                            <li
                                ...
                                style={{ '--feature-accent': row.accent }}
                            >
                                <div className="feature-line-toggle-main">
                                    ...
                                    <div className="feature-line-body">
                                        <div className="feature-line-title-row">
                                            ...
                                            {row.pill === 'premium' ? (
                                                <span className="feature-premium-pill">Paid Tier API</span>
                                            ) : null}
                                        </div>
